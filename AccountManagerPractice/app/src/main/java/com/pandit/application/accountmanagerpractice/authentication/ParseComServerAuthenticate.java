...
//            User createdUser = new Gson().fromJson(responseString, User.class);
        User  createdUser=new User();
            ...
            createdUser.setPhone("Some Value");
            createdUser.setAvatarUrl("Some Value");
            createdUser.setFirstName("Some Value");
            createdUser.setLastName("Some Value");
            createdUser.setSessionToken("54ax374179275x4as1dg65a6g871adg5455adsg5asd54");
...
//        return authtoken;
        ...
        loggedUser.firstName="Sourav Kumar";
        loggedUser.lastName=" Pandit";
        loggedUser.phone="+91781545722";
        loggedUser.sessionToken="ajhdf9283jbfd9vab8qb83h2qcadsffdafda";
        loggedUser.username="Sourav Pandit";
        loggedUser.objectId="455668";


        return loggedUser.sessionToken;
    }
